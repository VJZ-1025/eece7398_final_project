...
Understand "Village Committee" as r_1.
The internal name of r_1 is "Village Committee".
The printed name of r_1 is "-= Village Committee =-".
The Village Committee part 0 is some text that varies. The Village Committee part 0 is "A place where villagers gather to discuss community affairs.".
The description of r_1 is "[Village Committee part 0]".
...
Understand "Hospital" as r_2.
The internal name of r_2 is "Hospital".
The printed name of r_2 is "-= Hospital =-".
The Hospital part 0 is some text that varies. The Hospital part 0 is "Provides medical services to villagers.".
The description of r_2 is "[Hospital part 0]".
...
Understand "School" as r_3.
The internal name of r_3 is "School".
The printed name of r_3 is "-= School =-".
The School part 0 is some text that varies. The School part 0 is "Where children receive their education.".
The description of r_3 is "[School part 0]".
